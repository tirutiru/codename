...
var COLOR_RED = "#FF82A9";
var COLOR_YELLOW = "#FFEB5A";
var COLOR_BLUE = "#7F95D1";
var COLOR_BLACK = "#AAAAAA";
var COLOR_GREEN = "#cccccc";
...
function updateScore() {
	...
	if (spyMasterMode) {
		...
		$('div.word').each(function() {
			...
			if (color === 'rgb(127, 149, 209)') {
				blueScore++;
			}
			if (color === 'rgb(255, 130, 169)') {
				redScore++;
			}
		});
	} else {
